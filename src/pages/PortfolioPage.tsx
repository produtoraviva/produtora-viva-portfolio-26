          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                {siteSettings?.instagram_url && (
                  <a href={siteSettings?.instagram_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                {siteSettings?.facebook_url && (
                  <a href={siteSettings?.facebook_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                {siteSettings?.contact_phone_secondary && (
                  <li>{siteSettings?.contact_phone_secondary}</li>
                )}
